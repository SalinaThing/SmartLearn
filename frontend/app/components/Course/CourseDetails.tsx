        ...
        <div className="w-[90%] 800px:w-[90%] mx-auto py-5">
            <div className="w-full flex flex-col-reverse 800px:flex-row">
                            ...
                            {data.benefits?.map((item:any, index:number) =>(
                                <div className="w-full flex 800px:items-center py-2" key={index}>
                                    <div className="w-[15px] mr-1">
                                        <IoCheckmarkDoneCircleOutline size={20} className="text-black dark:text-white"/>
                                    </div>
                ...
                <div className="w-full 800px:w-[35%] relative">
                    <div className="stickey top-[100px] left-0 z-50 w-full">
                        <CoursePlayer
                        ...
                        <p className="pb-1 text-black dark:text-white"> · Access on mobile and TV</p>
