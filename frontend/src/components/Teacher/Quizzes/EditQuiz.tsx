...
import { useUpdateQuizMutation } from '@/redux/features/quizzes/quizApi';
...
const EditQuiz = ({ setRoute, quizData }: Props) => {
    ...
    return (
        <div className="w-[90%] m-auto mt-24">
            ...
            <form onSubmit={handleSubmit} className="mt-8">
                ...
                <div className="mt-10">
                    <h2 className="text-xl font-bold dark:text-white text-black">Questions</h2>
                    {quizInfo.questions.map((q: any, qIndex: number) => (
                ...
                <div className="mt-10 mb-20 text-center">
                    ...
                    <button 
                        ...
                        className={`${styles.button} !w-[200px] inline-block ml-4 bg-gray-500`}
                    >
                        Cancel
                    </button>
                </div>
