...
const AdminSidebar: FC<Props> = ({ activeItem, open, setOpen, isCollapsed, setIsCollapsed }) => {
    ...
    useEffect(() => {
        ...
        if (activeItem === 5) setSelected("FAQ");
        if (activeItem === 6) setSelected("Categories");
        if (activeItem === 7) setSelected("Manage Team");
                ...
                >
                    <Menu iconShape="square">
                        ...
                        {!isCollapsed && (
                            <Box mb="25px" className="flex flex-col items-center">
                                ...
                                <div className="text-center px-4">
                                    ...
                                    <p className="text-[14px] font-medium uppercase" style={{ color: isLightMode ? "#4b5563" : "#d1d5db" }}>
                                        - {user?.role} -
                                    </p>
                                </div>
                            </Box>
                        ...
                        >
                            ...
                            <Item title="Dashboard" to="/admin" icon={<WebIcon />} selected={selected} setSelected={setSelected} setOpen={setOpen} isLightMode={isLightMode} />
                            ...
                            <Item title="Users" to="/admin/users" icon={<GroupsIcon />} selected={selected} setSelected={setSelected} setOpen={setOpen} isLightMode={isLightMode} />
                            <Item title="Invoices" to="/admin/invoices" icon={<ReceiptOutlinedIcon />} selected={selected} setSelected={setSelected} setOpen={setOpen} isLightMode={isLightMode} />
                            ...
                            <Item title="FAQ" to="/admin/faq" icon={<FeedbackIcon />} selected={selected} setSelected={setSelected} setOpen={setOpen} isLightMode={isLightMode} />
                            <Item title="Categories" to="/admin/categories" icon={<WysiwygIcon />} selected={selected} setSelected={setSelected} setOpen={setOpen} isLightMode={isLightMode} />
                            ...
                            <Item title="Manage Team" to="/admin/team" icon={<PeopleOutlinedIcon />} selected={selected} setSelected={setSelected} setOpen={setOpen} isLightMode={isLightMode} />
